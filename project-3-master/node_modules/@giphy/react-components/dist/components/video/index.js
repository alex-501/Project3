...
var rendition_selection_1 = __importDefault(require("./rendition-selection"));
...
var Video = function (_a) {
    var _b;
    var muted = _a.muted, _c = _a.loop, loop = _c === void 0 ? true : _c, onStateChange = _a.onStateChange, onTimeUpdate = _a.onTimeUpdate, onCanPlay = _a.onCanPlay, onFirstPlay = _a.onFirstPlay, onWaiting = _a.onWaiting, onMuted = _a.onMuted, onError = _a.onError, onEnded = _a.onEnded, onLoop = _a.onLoop, onQuartile = _a.onQuartile, onEndFullscreen = _a.onEndFullscreen, setVideoEl = _a.setVideoEl, gif = _a.gif, width = _a.width, height_ = _a.height, _d = _a.volume, volume = _d === void 0 ? 0.7 : _d, className = _a.className;
    var height = height_ || js_util_1.getGifHeight(gif, width);
    // state
    var media = react_1.useRef(rendition_selection_1.default(gif.video, width, height));
    ...
    react_1.useEffect(function () {
        media.current = rendition_selection_1.default(gif.video, width, height);
    }, [width, height_]);
    ...
    var _onPaused = react_1.useCallback(function () { return onStateChange === null || onStateChange === void 0 ? void 0 : onStateChange('paused'); }, []);
    ...
    var _onCanPlay = react_1.useCallback(function () { return onCanPlay === null || onCanPlay === void 0 ? void 0 : onCanPlay(); }, []);
    ...
    var _onEnded = react_1.useCallback(function () { return onEnded === null || onEnded === void 0 ? void 0 : onEnded(); }, []);
    var _onEndFullscreen = react_1.useCallback(function () { return onEndFullscreen === null || onEndFullscreen === void 0 ? void 0 : onEndFullscreen(); }, []);
    var tryAutoPlayWithSound = function (videoEl) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return ((_b = media.current) === null || _b === void 0 ? void 0 : _b.url) ? (react_1.default.createElement("video", { className: className, width: width, height: height, loop: loop, muted: muted, autoPlay: true, playsInline: true, ref: videoEl, src: media.current.url })) : null;
};
