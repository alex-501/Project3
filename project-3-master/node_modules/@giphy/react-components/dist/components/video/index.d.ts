...
export declare type QuartileEvent = 0.25 | 0.5 | 0.75;
...
declare const Video: ({ muted, loop, onStateChange, onTimeUpdate, onCanPlay, onFirstPlay, onWaiting, onMuted, onError, onEnded, onLoop, onQuartile, onEndFullscreen, setVideoEl, gif, width, height: height_, volume, className, }: Props) => JSX.Element | null;
