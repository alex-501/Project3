import React, { useRef, useState } from 'react'; import "./Login.css";
import { Link } from "react-router-dom";import ErrorMessage from "../ErrorMessage";
...
const LoginForm = () => {
    ...
    return ( <Card className="text-white rounded-0" style={{ margin: '0px' }}>
